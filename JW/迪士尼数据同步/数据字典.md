...
| json     | object | 内容json信息【name:标题、author:作者、content:正文、summary:简介、pinyin:拼音】 |
...
| ---------------- | ------ | ------------------------------------ |
| oid              | string | 文章id                               |
| title            | object | 文章标题 eg (zh-cn：中文、en：英文)  |
| pinyin           | string | 拼音                                 |
| summary          | string | 简介                                 |
| content          | string | 正文                                 |
...
| app_id                  | string | 应用id                                                       |
| name                    | object | 抽奖模式名称 eg (zh-cn：中文、en：英文)                      |
...
| aid              | string | 奖品id                                                       |
| raffle_name      | object | 抽奖事件名称 eg (zh-cn：中文、en：英文)                      |
| play_game_name   | object | 抽奖形式名称 eg (zh-cn：中文、en：英文)                      |
| winning_flag     | int    | 是否中奖 0 否 1 是                                           |
| prize_name       | object | 奖品名称 eg (zh-cn：中文、en：英文)                          |
| price            | string | 奖品价格                                                     |
