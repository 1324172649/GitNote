...
#### 24、订阅号素材文章数据 starbucks_article_push
...
#### 26、订阅号历史文章数据 starbucks_article_send_push
...
#### 31、订阅号消息数据 starbucks_subscribe_message
...
#### 32、用户与订阅号消息关联数据 starbucks_message_expire_relation
...
#### 33、订阅号栏目数据 starbucks_sub_article_push
...
#### 34、订阅号操作日志数据 starbucks_sub_log
...
#### 36、活动与用户关联数据 starbucks_activity_user
...
#### 37、活动操作记录数据 starbucks_activity_log
...
#### 38、活动组数据 starbucks_activity_group
...
#### 40、用户积分数据 starbucks_user_score
...
#### 41、用户积分记录数据 starbucks_score_log
...
#### 42、表单子管理员组数据 starbucks_form_admingroup
...
#### 43、表单子管理员组关系数据 starbucks_form_admingroup_share
...
#### 44、表单分类数据 starbucks_form_category
...
#### 51、应用访问统计数据 starbucks_tenant_apps_action
...
#### 52、应用统计数据 starbucks_tenant_apps_data
...
#### 53、客户端统计数据 starbucks_tenant_client_data
...
#### 54、用户行为数据 starbucks_tenant_users
...
#### 55、应用访问统计数据 starbucks_apps_action_all
...
#### 56、应用数据统计数据 starbucks_apps_data_all
...
#### 58、用户行为统计数据 starbucks_users_action_all
...
#### 59、抽奖事件数据 starbucks_raffle_event
...
#### 60、奖品数据 starbucks_raffle_award
...
#### 61、抽奖声明模版数据 starbucks_raffle_state_template
...
#### 62、抽奖与对象关系数据 starbucks_raffle_obj_rel
...
#### 63、抽奖形式模版数据 starbucks_raffle_game_template
...
#### 64、抽奖形式数据 starbucks_raffle_game
...
#### 65、抽奖事件与抽奖人记录数据 starbucks_raffle_times_record
...
#### 66、抽奖人总的抽奖次数数据 starbucks_raffle_total_times_record
...
#### 67、抽奖记录数据 starbucks_raffle_record
...
#### 68、抽奖操作日志数据 starbucks_raffle_log
...
#### 69、抽奖用户范围数据 starbucks_raffle_userscope
...
#### 71、周年庆通知图库数据 starbucks_hrtool_gallery
...
#### 72、周年庆日志数据 starbucks_hrtool_log
...
#### 73、周年庆通知发送数据 starbucks_hrtool_sended
