...
#### 5、团队与用户层级关系 disney_user_dept_rel
...
#### 6、团队邀请成员数据 disney_dept_inviteuser
...
#### 16、用户组分组数据 disney_usergroup_class
...
#### 17、用户与用户组关系数据 disney_usergroup_rel
...
#### 24、订阅号素材文章数据 disney_article_push
...
#### 26、订阅号历史文章数据 disney_article_send_push
...
#### 28、订阅号反馈按钮数据 disney_sub_feedback_btn
...
#### 29、订阅号反馈数据 disney_sub_feedback_data
...
#### 30、订阅号人员管理数据 disney_sub_userscope
...
#### 31、订阅号消息数据 disney_subscribe_message
...
#### 32、用户与订阅号消息关联数据 disney_message_expire_relation
...
#### 33、订阅号栏目数据 disney_sub_article_push
...
#### 36、活动与用户关联数据 disney_activity_user
...
#### 37、活动操作记录数据 disney_activity_log
...
#### 38、活动组数据 disney_activity_group
...
#### 42、表单子管理员组数据 disney_form_admingroup
...
#### 43、表单子管理员组关系数据 disney_form_admingroup_share
...
#### 44、表单分类数据 disney_form_category
...
#### 49、表单模型字段数据 _appmaker_model_field
...
#### 51、应用访问统计数据 disney_tenant_apps_action
...
#### 52、应用统计数据 disney_tenant_apps_data
...
#### 53、客户端统计数据 disney_tenant_client_data
...
#### 55、应用访问统计数据 disney_apps_action_all
...
#### 56、应用数据统计数据 disney_apps_data_all
...
#### 58、用户行为统计数据 disney_users_action_all
...
#### 61、抽奖声明模版数据 disney_raffle_state_template
...
#### 62、抽奖与对象关系数据 disney_raffle_obj_rel
...
#### 63、抽奖形式模版数据 disney_raffle_game_template
...
#### 65、抽奖事件与抽奖人记录数据 disney_raffle_times_record
...
#### 66、抽奖人总的抽奖次数数据 disney_raffle_total_times_record
...
#### 67、抽奖记录数据 disney_raffle_record
...
#### 69、抽奖用户范围数据 disney_raffle_userscope ✅
...
#### 70、周年庆数据 disney_hrtool ✅

| 参数名称      | 类型   | 说明                                                         |
| ------------- | ------ | ------------------------------------------------------------ |
| id            | string | 生日周年庆唯一值                                             |
| name          | string | 周年庆名称                                                   |
| en_name       | string | 英文周年庆名称                                               |
...
#### 71、周年庆通知图库数据 disney_hrtool_gallery ✅

| 参数名称    | 类型   | 说明                             |
| ----------- | ------ | -------------------------------- |
| name        | string | 图库名称                         |
| en_name     | string | 英文图库名称                     |
| fid         | string | 图片/图库ID                      |
...
#### 73、周年庆通知发送数据 disney_hrtool_sended ✅
